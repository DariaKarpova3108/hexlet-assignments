...
public class ProductsController {
    ...
    @GetMapping
    public List<ProductDTO> getList(ProductParamsDTO paramsDTO, @RequestParam(defaultValue = "1") int page) {
        var spec = specification.build(paramsDTO);
        var list = productRepository.findAll(spec, PageRequest.of(page - 1, 10));
